...
#Read data
ds <- read.csv("C:\\virtual_environment\\ML-Models\\k-means\\ac_data.csv",stringsAsFactors=FALSE)
...
report <- read.csv("C:\\virtual_environment\\ML-Models\\k-means\\report_lemma.csv",stringsAsFactors=FALSE)
...
#Find correlations among terms to further exploration
